...
then
    ...
    CLI_CONFIGURED_COLOR="1";
    # echo "${undblu}${undred}ALLREDY${txtrst} ${bakgrn}${bldblk}COLORED${txtrst}";
# else
#     echo "${bakylw}${undred}ALLREDY${txtrst} ${bakgrn}${bldblk}COLORED${txtrst}";
fi
